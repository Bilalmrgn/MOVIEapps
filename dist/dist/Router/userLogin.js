...
router.post('/login', function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, password, user, validPassword, payload, token;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (!validPassword) {
                        return [2 /*return*/, res.send('Password is wrong')];
                    }
                    payload = {
                        username: username
                    };
                    token = jwt.sign(payload, req.body.get(apiSecretKey.api_secret_key), { expiresIn: '1h' });
