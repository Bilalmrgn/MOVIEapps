...
app.set('api_secret_key', apiSecretKey.api_secret_key);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ConnectionToDatabase()];
                case 1:
                    //mongoDB bağlantısı başlat
                    _a.sent();
                    ...
                    app.listen(port_1, function () {
                        console.log("sunucu ".concat(port_1, " portunda calisiyor"));
                    });
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.log('Hata: ' + error_1);
                    return [3 /*break*/, 3];
